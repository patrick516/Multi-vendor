  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid gap-8 rounded-3xl bg-gradient-to-br from-emerald-50 via-white to-slate-50 px-4 py-8 md:grid-cols-[minmax(0,2.1fr),minmax(0,1.5fr)] md:px-8 md:py-10">
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            ...
            <p className="max-w-xl text-lg text-slate-600 font-montserrat">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className="rounded-md bg-green-600 px-5 py-2.5 text-md font-semibold text-white shadow-sm hover:bg-green-700"
            >
              Browse products
            </button>
            <button
              ...
              className="rounded-md border border-slate-300 bg-white px-5 py-2.5 text-md font-semibold text-slate-800 hover:bg-slate-50"
            >
              How it works
            </button>
          </div>
              ...
              <>
                <div className="flex items-center justify-center h-40 gap-4 rounded-xl bg-gradient-to-br from-emerald-50 via-sky-50 to-slate-50">
                  ...
                  <div className="flex flex-col justify-between flex-1 h-28">
                    ...
                    <button
                      ...
                      className="self-start mt-2 rounded-md bg-green-600 px-3 py-1.5 text-[11px] font-semibold text-white hover:bg-green-700"
                    >
                      View product
                    </button>
                  </div>
                ...
                <div className="flex items-center justify-between mt-4">
                  <button
                    type="button"
                    onClick={handleBrowseClick}
                    className="rounded-md bg-emerald-600 px-3 py-1.5 text-md font-semibold text-white hover:bg-emerald-700"
                  >
                    Search
                  </button>
                  <div className="px-3 py-2 text-right rounded-lg bg-emerald-50">
                    ...
                    <p className="text-md text-emerald-700">Active listings</p>
                  </div>
                </div>
              </>
            ) : (
      ...
      >
        <div className="grid gap-3 md:grid-cols-[1fr,1fr,2fr,auto] items-end">
          ...
          <div className="flex items-end">
            <button
              onClick={handleBrowseClick}
              className="w-full rounded-md bg-green-600 px-4 py-2.5 text-md font-semibold text-white shadow-sm hover:bg-green-700"
            >
              Search
            </button>
          </div>
        ...
        <p className="mt-2 text-md text-slate-500 font-montserrat">
      ...
      <section className="space-y-3">
        ...
        {loadingTop && (
          <p className="text-md text-slate-500">Loading top products…</p>
        )}
